...
Vector integer add and subtract are provided. Reverse-subtract (scalar - vec[i]) instructions are also provided for the vector-scalar forms.
...
The widening add/subtract have both signed and unsigned variants.
